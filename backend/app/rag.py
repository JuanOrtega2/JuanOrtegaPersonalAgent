...
class RAGManager:
    def __init__(self):
        # Aseguramos que use la clave de Google y un modelo compatible
    ...
    def ingest_qa(self, qa_path: str):
        """Procesa la base de conocimientos de Q&A (JSON)."""
        ...
        # Convertir Q&A en documentos formateados
        qa_docs = []
        for item in data:
